...
namespace DreamTimeS224.Data.Migrations
{
    ...
    [Migration("20241112023100_AddSessionModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Session", b =>
                {
            ...
            modelBuilder.Entity("DreamTimeS224.Models.SessionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Timeslot", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Time = new DateTime(1, 1, 1, 8, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                        ...
                        new
                        {
                            Time = new DateTime(1, 1, 1, 17, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Time = new DateTime(1, 1, 1, 18, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Time = new DateTime(1, 1, 1, 18, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Time = new DateTime(1, 1, 1, 19, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Time = new DateTime(1, 1, 1, 19, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                        ...
                        new
                        {
                            Time = new DateTime(1, 1, 1, 20, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Time = new DateTime(1, 1, 1, 21, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                        ...
                        new
                        {
                            Time = new DateTime(1, 1, 1, 22, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Book", b =>
                {
                    b.HasOne("DreamTimeS224.Models.Genre", "Genre")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Room", b =>
                {
                    b.HasOne("DreamTimeS224.Models.RoomType", "RoomType")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("DreamTimeS224.Models.Session", b =>
                {
                    b.HasOne("DreamTimeS224.Models.Timeslot", "EndTime")
                        .WithMany()
                        .HasForeignKey("EndTimeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DreamTimeS224.Models.SessionType", "SessionType")
                        .WithMany()
                        .HasForeignKey("SessionTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DreamTimeS224.Models.Timeslot", "StartTime")
                        .WithMany()
